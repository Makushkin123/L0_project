...
Что было сделано:
1)создал табличку в бд
2)валидация json/не json из канала, проверки на содержание всех аттрибутов в json нет в сервисе
3)кэшую в мапу и во время запуска сервиса данные копируются из бд
4)создан простейший интерфейс 
